...
urlpatterns = [
    ...
    #this '' url became unique so our url in contact app became valid
    #but when i removed 'test' and only put '' this pattern is repeated and urls should not be duplicate
]
